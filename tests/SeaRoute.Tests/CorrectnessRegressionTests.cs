...
public class CorrectnessRegressionTests
{
    ...
    {
        var options = new SeaRouteOptions { SpeedKnots = double.NaN, Algorithm = "guess" };
        var act = () => SeaRouter.Calculate(new Coordinate(0, 0), new Coordinate(1, 1), options: options);
    ...
    {
        var options = new SeaRouteOptions { Algorithm = "guess" };
        var act = () => SeaRouter.Calculate(new Coordinate(0, 0), new Coordinate(1, 1), options: options);
    ...
    {
        var options = new SeaRouteOptions { Restrictions = ["not_a_passage"] };
        var act = () => SeaRouter.Calculate(new Coordinate(0, 0), new Coordinate(1, 1), options: options);
    ...
    {
        var act = () => SeaRouter.CalculateMovement("Airport CNSHG to Port GBFXT Road");
